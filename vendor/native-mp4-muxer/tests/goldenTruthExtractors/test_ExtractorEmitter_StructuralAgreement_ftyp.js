...
/**
 * test_ExtractorEmitter_StructuralAgreement_ftyp
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_ftyp() {
    ...
    // ---------------------------------------------------------
    // Resolve FTYP via Golden Truth dispatcher
    // ---------------------------------------------------------
    const truth =
    ...
    // ---------------------------------------------------------
    assertBoxStructuralEqual(
        "emitFtypBox() structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "ftyp"
        ),
