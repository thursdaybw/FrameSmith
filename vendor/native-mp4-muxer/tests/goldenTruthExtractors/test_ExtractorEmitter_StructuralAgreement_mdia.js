...
/**
 * test_ExtractorEmitter_StructuralAgreement_mdia
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_mdia() {
    ...
    // ---------------------------------------------------------
    // Resolve mdia via Golden Truth dispatcher
    // ---------------------------------------------------------
    ...
    assertBoxStructuralEqual(
        "assembleMdia(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak/mdia"
        ),
