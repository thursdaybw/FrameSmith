...
/**
 * test_ExtractorEmitter_StructuralAgreement_trak
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_trak() {
    ...
    // ---------------------------------------------------------
    // Resolve trak via Golden Truth dispatcher
    // ---------------------------------------------------------
    ...
    assertBoxStructuralEqual(
        "assembleTrak(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak"
        ),
