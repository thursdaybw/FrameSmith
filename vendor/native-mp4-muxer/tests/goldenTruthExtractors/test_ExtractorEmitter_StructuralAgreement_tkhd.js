...
/**
 * test_ExtractorEmitter_StructuralAgreement_tkhd
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_tkhd() {
    ...
    // ---------------------------------------------------------
    // Resolve TKHD via Golden Truth dispatcher
    // ---------------------------------------------------------
    const truth =
    ...
    assertBoxStructuralEqual(
        "emitTkhdBox(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak/tkhd"
        ),
