...
/**
 * test_ExtractorEmitter_StructuralAgreement_minf
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_minf() {
    ...
    // ---------------------------------------------------------
    // Resolve minf via Golden Truth dispatcher
    // ---------------------------------------------------------
    ...
    assertBoxStructuralEqual(
        "assembleMinf(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak/mdia/minf"
        ),
