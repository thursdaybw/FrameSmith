...
/**
 * test_ExtractorEmitter_StructuralAgreement_mdhd
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_mdhd() {
    ...
    // ---------------------------------------------------------
    // Resolve mdhd via Golden Truth dispatcher
    // ---------------------------------------------------------
    ...
    assertBoxStructuralEqual(
        "emitMdhd(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak/mdia/mdhd"
        ),
