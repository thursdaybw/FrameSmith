...
/**
 * test_ExtractorEmitter_StructuralAgreement_stss
 *
 * This test proves:
 ...
 */
export async function test_ExtractorEmitter_StructuralAgreement_stss() {
    ...
    // ---------------------------------------------------------
    // Resolve stss via Golden Truth dispatcher
    // ---------------------------------------------------------
    ...
    assertBoxStructuralEqual(
        "emitStssBox(input) structure matches readBoxReport().box",
        normalizeEmitterNodeToSchemaBox(
            node,
            "moov/trak/mdia/minf/stbl/stss"
        ),
